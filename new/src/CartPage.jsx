            ...
            <header className="sticky top-0 z-50 bg-[#fffcfc]/85 backdrop-blur-lg border-b border-stone-100 px-4 md:px-8 h-[64px] flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div className="leading-tight">
                        <h1 className="text-xl font-[900] tracking-tight text-stone-900">Your Bag</h1>
                ...
                <span className="text-xs font-[900] bg-pink-50 text-pink-600 px-3 py-1.5 rounded-full">
                    {cartItems.length} Items
                </span>
            </header>

            {/* Main */}
            <main className="w-full px-4 md:px-8 py-6 md:py-8 grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-8 md:gap-10">
                {/* Left */}
                <div className="flex flex-col gap-6 min-w-0">
                    {cartItems.length === 0 ? (
                        ...
                        <>
                            {/* Free Shipping */}
                            <div className="bg-gradient-to-r from-pink-50/60 to-purple-50/60 border border-pink-100/60 rounded-[24px] p-5 shadow-sm relative overflow-hidden">
                                <div className="flex items-start justify-between gap-4 mb-3">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="text-sm font-[900] text-stone-900">
                                    ...
                                    {shipProgress.remaining > 0 && (
                                        <button
                                            ...
                                            className="text-xs font-[900] text-pink-600 hover:text-pink-700 flex items-center gap-1"
                                        >
                            ...
                            <div className="flex items-center justify-between px-1">
                                <button onClick={toggleSelectAll} className="flex items-center gap-2 group">
                                    ...
                                    <span className="text-sm font-[900] text-stone-900">Select all</span>
                                </button>
                            ...
                            {standardItems.length > 0 && (
                                <section className="flex flex-col gap-4">
                                    <div className="flex items-center gap-2 px-1">
                                        ...
                                        <h3 className="text-xs font-[900] text-stone-500 uppercase tracking-widest">Ships soon</h3>
                                    </div>
                            ...
                            {preOrderItems.length > 0 && (
                                <section className="flex flex-col gap-4">
                                    <div className="flex items-center gap-2 px-1">
                                        ...
                                        <h3 className="text-xs font-[900] text-purple-500 uppercase tracking-widest">Pre-orders</h3>
                                    </div>
                                    ...
                                    <div className="bg-purple-50/35 border border-purple-100/60 rounded-[26px] p-3 flex flex-col gap-3">
                                        ...
                                        <p className="text-[11px] text-stone-600 font-semibold flex items-center gap-1.5 px-1 pt-1">
                                            <Info size={12} className="text-purple-500" /> Pre-order items ship on their release date. Cancel
              ...
              - On mobile: normal flow (no sticky, no height clamp)
            */}
                        <div className="lg:sticky lg:top-20 space-y-4">
                                ...
                                {appliedPromo ? (
                                    <div className="flex items-center justify-between bg-green-50/50 p-3 rounded-[18px] border border-green-100">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="leading-tight">
                                                <p className="text-xs font-[900] text-stone-900">{appliedPromo.code}</p>
                                    ...
                                    <div className="flex gap-2 p-1">
                                        ...
                                        <button
                                            ...
                                            className="bg-stone-900 text-white rounded-[16px] px-5 text-sm font-[900] hover:bg-stone-800 disabled:opacity-50 transition-all"
                                        >
                            ...
                            <div className="bg-white/70 backdrop-blur-md rounded-[28px] p-6 border border-white shadow-[0_10px_40px_rgba(0,0,0,0.04)]">
                                <h2 className="text-lg font-[900] text-stone-900 mb-6">Order Summary</h2>
                                ...
                                <div className="space-y-3 mb-6">
                                    ...
                                    <div className="flex justify-between items-center">
                                        <span className="text-stone-900 font-[900] text-lg">Total</span>
                                        <span className="text-stone-900 font-[900] text-xl">{formatINR(total)}</span>
                                    </div>
                                </div>
                                ...
                                <button
                                    ...
                                    className="w-full py-4 bg-stone-900 text-white rounded-[20px] font-[900] text-[15px] hover:bg-pink-600 hover:shadow-lg hover:shadow-pink-200/50 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed group flex items-center justify-center gap-2"
                                >
                                    Proceed to Checkout
                                ...
                                {hasOutOfStockSelected && (
                                    <p className="text-[11px] text-center text-red-500 font-[900] mt-3 bg-red-50 py-2 rounded-lg">
            ...
            {cartItems.length > 0 && (
                <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-lg border-t border-stone-100 p-4 pb-8 z-50 flex items-center gap-4 shadow-2xl">
                    <div className="flex-1">
                        <p className="text-[10px] text-stone-500 font-[900] uppercase tracking-wider">Total</p>
                        <p className="text-xl font-[900] text-stone-900">{formatINR(total)}</p>
                        <p className="text-[10px] text-stone-500 font-semibold">{selectedItems.length} selected</p>
                    </div>
                    <button
                        onClick={handleCheckout}
                        disabled={!canCheckout}
                        className="flex-[1.5] py-3.5 bg-stone-900 text-white rounded-[16px] font-[900] text-sm hover:bg-pink-600 transition-colors shadow-lg disabled:opacity-50"
                    >
                        Checkout
                    </button>
                </div>
                ...
                <div className="w-24 h-28 rounded-[18px] bg-stone-50 overflow-hidden shrink-0 relative flex items-center justify-center">
                    ...
                    {isOutOfStock && (
                        <div className="absolute inset-0 flex items-center justify-center bg-black/10">
                            <span className="text-[10px] font-[900] text-white bg-black/70 px-2 py-1 rounded-full uppercase">
                                Out of Stock
                            </span>
                        </div>
                    )}
                ...
                <div className="flex-1 min-w-0 flex flex-col justify-between py-1">
                    <div className="flex justify-between items-start gap-3">
                        <div className="min-w-0">
                            {isPreOrder && (
                                <span className="inline-flex items-center gap-1 text-[9px] font-[900] text-purple-600 bg-purple-50 px-2 py-1 rounded-[8px] mb-2 uppercase tracking-wide">
                        ...
                        <p className="text-base font-[900] text-stone-900 whitespace-nowrap">{formatINR((item.price || 0) * (item.qty || 1))}</p>
                    </div>
                    ...
                    <div className="flex items-center justify-between mt-4 gap-3">
                        ...
                        <div className="flex items-center gap-1 bg-stone-50 rounded-[14px] p-1 border border-stone-100">
                            ...
                            <span className="w-8 text-center text-sm font-[900]">{item.qty || 1}</span>
                            <button
                                onClick={() => onUpdateQty(item, (item.qty || 1) + 1)}
                                className="w-7 h-7 flex items-center justify-center rounded-[10px] bg-white text-stone-600 hover:text-black shadow-sm disabled:opacity-50"
                        ...
                        <div className="flex items-center gap-3">
                            <button
                                onClick={onWishlist}
                                className="text-stone-400 hover:text-pink-500 transition-colors flex items-center gap-1 text-xs font-[900]"
                                title="Save"
                            >
                            ...
                            <button
                                onClick={onRemove}
                                className="text-stone-400 hover:text-red-500 transition-colors flex items-center gap-1 text-xs font-[900]"
                                title="Remove"
                            >
...
function SummaryRow({ label, value, highlight }) {
    return (
        <div className="flex justify-between items-center text-sm">
            ...
            <span className={`font-[900] ${highlight ? "text-pink-600" : "text-stone-900"}`}>{value}</span>
        </div>
    );
}
...
function TrustItem({ icon: Icon, label }) {
    return (
        <div className="flex flex-col items-center gap-2 text-center">
            ...
            <span className="text-[10px] font-[900] text-stone-400 uppercase tracking-wide">{label}</span>
        </div>
    );
}
...
function RecCard({ product, onAdd }) {
    return (
        <div className="min-w-[180px] snap-start group">
            <div className="aspect-[4/5] rounded-[20px] bg-stone-100 overflow-hidden relative mb-3">
                <img
                    src={product.image}
            ...
            <h4 className="font-[900] text-sm text-stone-900 truncate">{product.name}</h4>
            <p className="text-[11px] text-stone-500 mb-1 truncate">{product.tag}</p>
            <p className="text-xs font-[900] text-stone-900">{formatINR(product.price)}</p>
        </div>
    );
}
...
function EmptyState() {
    return (
        <div className="flex flex-col items-center justify-center py-24 text-center">
            <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-pink-100 to-purple-100 flex items-center justify-center mb-6 shadow-xl shadow-pink-100/50">
                <Gift size={40} className="text-pink-500" />
            </div>
            <h2 className="text-2xl font-[900] text-stone-900 mb-3 tracking-tight">Your bag is feeling light</h2>
            <p className="text-stone-500 mb-8 max-w-sm leading-relaxed">
                Discover new arrivals and best sellers to find your next skincare obsession.
            </p>
            <div className="flex gap-4">
                <Link
                    to="/best-sellers"
                    className="px-8 py-3.5 bg-stone-900 text-white rounded-[18px] font-[900] text-sm hover:bg-pink-600 hover:shadow-lg hover:shadow-pink-200/50 transition-all"
                >
                    Shop Best Sellers
                </Link>
                <Link
                    to="/shop"
                    className="px-8 py-3.5 bg-white border border-stone-200 text-stone-900 rounded-[18px] font-[900] text-sm hover:border-pink-200 hover:bg-pink-50/50 transition-all"
                >
                    Explore All
                </Link>
            </div>
