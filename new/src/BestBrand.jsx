...
const BRANDS = [
  {
    ...
    heroImage:
      "https://images.unsplash.com/photo-1556228578-0d85b1a4d571?auto=format&fit=crop&w=1200",
    products: [
      {
        id: "rl1",
        ...
        discount: 25,
        image:
          "https://images.unsplash.com/photo-1556228578-0d85b1a4d571?auto=format&fit=crop&w=400",
      },
      {
        id: "rl2",
        ...
        originalPrice: 1300,
        discount: 25,
        image: "/src/assets/products/dokdo_cleanser.png",
      },
      {
        id: "rl3",
        ...
        discount: 30,
        image:
          "https://images.unsplash.com/photo-1571781926291-c477ebfd024b?auto=format&fit=crop&w=400",
      },
    ],
  },
  {
    ...
    heroImage:
      "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&w=1200",
    products: [],
  },
  {
    id: "medicube",
    ...
    heroImage:
      "https://images.unsplash.com/photo-1512496015851-a90fb38ba796?auto=format&fit=crop&w=1200",
    products: [],
  },
  {
    id: "dr-althea",
    ...
    heroImage:
      "https://images.unsplash.com/photo-1490231324208-a530768e142e?auto=format&fit=crop&w=1200",
    products: [],
  },
];
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center justify-between px-20">
              <div className="max-w-md z-10 group-hover/banner:translate-x-4 transition-transform duration-1000">
                <span className="text-[10px] font-[1000] text-white/60 uppercase tracking-[0.4em] mb-4 block">
                  BRAND OF THE MONTH
                </span>
