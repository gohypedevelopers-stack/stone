...
export default React.memo(function UpcomingDrops({
  onNavigate,
  title,
  products = [],
}) {
  ...
  return (
    <>
              ...
              {title ? (
                title.split(" ").map((word, i) =>
                  i === 1 ? (
                    <span
                      key={i}
                      className="text-transparent bg-clip-text bg-linear-to-r from-[#b36cff] to-[#ff5db1]"
                    >
                      {" "}
                      {word}{" "}
                    </span>
                      ...
                      <div className="relative aspect-4/5 w-full overflow-hidden bg-stone-50 border-b border-stone-100">
                        ...
                        {product.image ? (
                          ...
                          <div className="w-full h-full flex items-center justify-center bg-stone-100/50">
                            <Sparkles
                              size={24}
                              className="text-stone-300 opacity-50"
                            />
                          </div>
                        )}
      ...
      <Dialog
        open={!!notifyProduct}
        onOpenChange={(open) => !open && setNotifyProduct(null)}
      >
