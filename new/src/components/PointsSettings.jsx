  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-32">
        <div className="h-10 w-10 animate-spin rounded-3xl border-4 border-stone-200 border-t-indigo-950" />
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-5 max-w-[1100px]">
      ...
      <header className="flex items-end justify-between">
        <div>
          <div className="flex items-center gap-3 mb-2">
            <div className="h-10 w-10 rounded-3xl bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center shadow-lg shadow-amber-500/25">
        ...
        <div className="flex items-center gap-3">
          {hasChanges && (
            <Button
              variant="ghost"
              onClick={handleReset}
              className="rounded-3xl h-11 px-5 text-stone-500 hover:text-stone-800 font-semibold text-xs gap-2"
            >
          ...
          <Button
            ...
            className="bg-indigo-950 text-white rounded-3xl h-11 px-8 font-bold text-xs flex items-center gap-2.5 shadow-xl shadow-indigo-950/20 hover:bg-[#1a0b2e] transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-40 disabled:hover:scale-100"
          >
      ...
      <div className="relative rounded-3xl overflow-hidden">
        ...
        {/* Decorative circles */}
        <div className="absolute -top-20 -right-20 w-64 h-64 bg-violet-500/10 rounded-3xl blur-3xl" />
        <div className="absolute -bottom-16 -left-16 w-48 h-48 bg-amber-500/10 rounded-3xl blur-3xl" />

        <div className="relative z-10 p-8 flex items-center justify-between">
          <div className="flex items-center gap-6">
            <div className="h-16 w-16 rounded-3xl bg-white/[0.08] backdrop-blur-xl flex items-center justify-center border border-white/[0.08] shadow-2xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Points Per Amount */}
        <Card className="border border-stone-200/60 rounded-3xl shadow-sm hover:shadow-lg transition-all duration-300 group bg-white">
          <CardContent className="p-7">
            <div className="flex items-center gap-3 mb-6">
              <div className="h-11 w-11 rounded-3xl bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center shadow-md shadow-amber-500/20 group-hover:shadow-lg group-hover:shadow-amber-500/30 transition-shadow">
            ...
            <div className="flex items-center gap-3 mb-5">
              <button
                ...
                className="h-14 w-14 rounded-3xl border-2 border-stone-200 flex items-center justify-center hover:border-rose-300 hover:bg-rose-50 hover:text-rose-600 transition-all disabled:opacity-30 disabled:pointer-events-none active:scale-90"
              >
              ...
              <div className="flex-1 relative">
                <Input
                  ...
                  className="text-center text-4xl font-black h-14 rounded-2xl border-2 border-stone-200 focus-visible:ring-0 focus-visible:border-indigo-400 bg-stone-50/50 shadow-none transition-colors"
                />
              </div>

              <button
                onClick={() => setPointsPerAmount(pointsPerAmount + 1)}
                className="h-14 w-14 rounded-3xl border-2 border-stone-200 flex items-center justify-center hover:border-emerald-300 hover:bg-emerald-50 hover:text-emerald-600 transition-all active:scale-90"
              >
            ...
            <div className="grid grid-cols-4 gap-3">
              {[1, 2, 5, 10].map((val) => (
                <button
                  ...
                  className={`py-2.5 rounded-3xl text-xs font-bold transition-all duration-200 ${
                    pointsPerAmount === val
        ...
        <Card className="border border-stone-200/60 rounded-3xl shadow-sm hover:shadow-lg transition-all duration-300 group bg-white">
          <CardContent className="p-7">
            <div className="flex items-center gap-3 mb-6">
              <div className="h-11 w-11 rounded-3xl bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center shadow-md shadow-emerald-500/20 group-hover:shadow-lg group-hover:shadow-emerald-500/30 transition-shadow">
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <div className="flex-1 relative">
                ...
                <Input
                  ...
                  className="text-center text-4xl font-black h-14 rounded-2xl border-2 border-stone-200 focus-visible:ring-0 focus-visible:border-indigo-400 bg-stone-50/50 pl-10 shadow-none transition-colors"
                />
              </div>
      ...
      {/* How It Works */}
      <div className="bg-stone-50/80 border border-stone-200/60 rounded-3xl p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            <div key={i} className="flex items-center flex-1">
              <div className={`flex items-center gap-2.5 ${step.color} border rounded-3xl px-4 py-3 flex-1`}>
      ...
      {/* Earnings Preview */}
      <Card className="border border-stone-200/60 rounded-3xl overflow-hidden shadow-sm bg-white">
        <CardHeader className="px-7 py-5 border-b border-stone-100 bg-stone-50/30">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="h-9 w-9 rounded-3xl bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center shadow-md shadow-violet-500/20">
            ...
            <Badge className="bg-indigo-50 text-indigo-700 border-indigo-100 font-bold text-[10px] rounded-3xl px-3 py-1 border">
              Live Preview
            </Badge>
          </div>
        </CardHeader>
