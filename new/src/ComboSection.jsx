...
// Mock data for the Combos section
const COMBOS = [
  {
    id: "combo-1",
    brand: "MOIDA",
  ...
  <div className="flex flex-col group cursor-pointer group/card">
    ...
    <div className={`relative aspect-square rounded-[40px] overflow-hidden mb-6 bg-gradient-to-br ${combo.color} border border-stone-100 shadow-sm group-hover/card:shadow-md transition-all duration-700 transform-gpu optimize-gpu`}>
      ...
      <div className="absolute top-6 right-6">
        <div className="px-3 py-1 bg-[#151515] text-white text-[8px] font-black uppercase tracking-[0.2em] rounded-full shadow-xl border border-white/10">
          {combo.badge}
        </div>
      </div>
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover/card:opacity-100 transition-all duration-500">
        <div className="w-14 h-14 rounded-full bg-white text-[#151515] flex items-center justify-center shadow-2xl scale-90 group-hover/card:scale-100 transition-transform">
          <Search size={20} />
        </div>
      </div>
    </div>
